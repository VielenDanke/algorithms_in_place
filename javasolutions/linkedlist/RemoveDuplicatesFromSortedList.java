...
public class RemoveDuplicatesFromSortedList {
    ...
    public static void main(String[] args) {
        ListNode result = RemoveDuplicatesFromSortedList.deleteDuplicates(new ListNode(1, new ListNode(2, new ListNode(3, new ListNode(3, new ListNode(4, new ListNode(4, new ListNode(5, null))))))));
        while (result != null) {
