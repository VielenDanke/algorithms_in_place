...
public class MaxNumberOfKSumPairs_1679 {
    ...
    /*
    1. Sort array and use advance of two pointers (if sum > target - decrease right, if sum < target - increase left)
    2. Using visited array - if we find a sum, we will mark index as visited
     */
